...
(function() {
  ...
  Router.route('/HomeClassic', function() {
    this.render('HomeClassic');
    return {
      where: 'server'
    };
  });
  ...
  Router.route('/Embedded', function() {
    var me;
    me = this;
    if (this.params.query.serverURL) {
      Session.set('serverURL', this.params.query.serverURL);
      Session.set('tinkerPopVersion', '3');
      Session.set('graphName', 'the default graph');
  ...
  Router.route('/quikvis', function() {
    ...
    Session.set('tinkerPopVersion', 3);
    window.UsingGraphSON3 = JSON.parse(this.params.query.graphSON3);
