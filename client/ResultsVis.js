...
(function() {
  ...
  Template.ResultsVis.rendered = function() {
    ...
    return window.hidden4 = window.hidden4 ? window.hidden4 : {
      nodes: [],
      edges: [],
      positions: {}
    };
...
//unpin edges
  ...
  growSelections = function() {
    if (window.UsingGraphSON3) {
      return growSelectionsGraphSON3();
    } else {
      return growSelectionsGraphSON1();
    }
  };

  growSelectionsGraphSON1 = function() {
  ...
  growSelectionsGraphSON3 = function() {
    var bindings, elementIDs, nl, request, script, startTime;
    //grow means add neighboring vertices and their edges from the database into the local render
    elementIDs = window.visnetwork.getSelection();
    if (elementIDs.nodes.length > 0) {
        ...
        window.socketToJanus.onmessage = function(msg) {
          ...
          if (json.status.code >= 500) {
            ...
            if (json.status.code === 204) {
              ...
              nds = window.visnetwork.body.data.nodes.getDataSet();
              eds = window.visnetwork.body.data.edges.getDataSet();
              inVs = _.filter(arrayFromGraphSON3List(results[0]), function(e) {
                var eID;
                eID = e['@value']['id']['@value'];
                return nds.get(eID) === null;
              });
              outVs = _.filter(arrayFromGraphSON3List(results[1]), function(e) {
                var eID;
                eID = e['@value']['id']['@value'];
                return nds.get(eID) === null;
              });
              inEs = _.filter(arrayFromGraphSON3List(results[2]), function(e) {
                var eID;
                eID = e['@value']['id']['@value']['relationId'];
                return eds.get(eID) === null;
              });
              outEs = _.filter(arrayFromGraphSON3List(results[3]), function(e) {
                var eID;
                eID = e['@value']['id']['@value']['relationId'];
                return eds.get(eID) === null;
              });
          ...
          callback: function() {
            ...
            currentSelectedNodeIDs = _.union(currentSelectedNodeIDs, (function() {
              ...
              for (l = 0, len1 = selectedVerts.length; l < len1; l++) {
                ...
                results1.push(each['@value'].id['@value'] + "");
              }
              return results1;
            })());
  ...
  addInTheNeighbors = function(nodes2Select, edges2Select, allV, allE) {
    ...
    (function() {
      ...
      for (j = 0, len = allV.length; j < len; j++) {
        v = allV[j];
        results1.push(v['@value']['type'] = 'vertex');
      }
      return results1;
    })();
    if (window.UsingGraphSON3) {
      nodes = (function() {
        ...
        for (j = 0, len = allV.length; j < len; j++) {
          ...
          results1.push({
            ...
            label: labelForVertexGraphSON3(v['@value'], Session.get('keyForNodeLabel')),
            allowedToMoveX: true,
            allowedToMoveY: true,
    ...
    (function() {
      ...
      for (j = 0, len = allE.length; j < len; j++) {
        e = allE[j];
        results1.push(e['@value']['type'] = 'edge');
      }
      return results1;
    })();
    if (window.UsingGraphSON3) {
      edges = (function() {
        ...
        for (j = 0, len = allE.length; j < len; j++) {
          e = allE[j];
          results1.push({
            id: String(e['@value']['id']['@value']['relationId']),
            label: e['@value'].label,
            from: String(e['@value'].outV['@value']),
            to: String(e['@value'].inV['@value']),
            title: titleForElementGraphSON3(e['@value']),
            element: e['@value']
          });
        }
        return results1;
