...
//its not an array, assume an object
  ...
  currentPropertyTypesGraphSON3 = function(elementType, id) {
  ...
  buildTypeSelectorHTMLGraphSON3 = function(id, key, type, elementType) {
  ...
  javaValueExpressionGraphSON3 = function(element, key, value, type) {
    var dateTest, expression, num, str;
    ...
    if (type === 'Geoshape') {
      if (!((str.slice(0, "Geoshape.fromWkt".length) === "Geoshape.fromWkt") || (str.slice(0, "Geoshape.point".length) === "Geoshape.point") || (str.slice(0, "Geoshape.circle".length) === "Geoshape.circle"))) {
  ...
  window.updatePropsForElementGraphSON3 = function(elementType, id, newProps, oldProps) {
    var allKeys, bindings, changedProps, changedTypes, clientElement, j, key, keys2Delete, l, len, len1, len2, m, propTypes, propVal, ref, ref1, request, script, startTime;
